...
/**
 * Presence + typing indicator over Supabase Realtime only.
 * Nothing is written to the database, so this stays cheap at any message volume.
 */
export function usePresence(options: {
  ...
  /** Debounced: at most one broadcast per second while typing. */
