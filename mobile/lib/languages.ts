/**
 * Copied from src/lib/languages.ts (web) — pure data/lookup helpers, no
 * platform-specific code, kept as a straight port rather than a shared
 * package to avoid a cross-workspace Metro config for Phase 1.
 */
