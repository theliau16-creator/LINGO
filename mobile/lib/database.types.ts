// This file is automatically generated by Supabase from the DB schema — do
// not edit it directly. Copied verbatim from src/integrations/supabase/types.ts
// (web) so the mobile Supabase client is typed too; re-copy after a schema
// migration changes the two out of sync.
export type Json =
  | string
  | number
  | boolean
